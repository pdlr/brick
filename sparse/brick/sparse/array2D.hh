/**
***************************************************************************
* @file brick/sparse/array2D.hh
*
* Header file declaring a sparse matrix class.
*
...
#ifndef BRICK_SPARSE_ARRAY2D_HH
#define BRICK_SPARSE_ARRAY2D_HH
...
namespace brick {
  ...
  namespace sparse {
    ...
    /**
     ** The sparse::Array2D class template represents a sparse 2D
     ** array of arbitrary type.  This class has internal reference
     ** counting.  The default internal representation is "Dictionary
     ** of Keys," however the class provides member functions for
     ...
     ** @endcode
     **
     ** Unlike brick::numeric::array2D::copy(),
     ** brick::sparse::array2D::copy() may allocate memory, however it
     ** will throw an exception if the two arrays have different
     ** shapes.
     **/
    template <class Type>
    class Array2D {
...
#endif /* #ifdef BRICK_SPARSE_ARRAY2D_HH */
