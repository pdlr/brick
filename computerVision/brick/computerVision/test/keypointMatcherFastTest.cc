...
namespace brick {
  ...
  namespace computerVision {
    ...
    {
      // Carefully crafted array of keypoints against which to match.
      const unsigned int numberOfKeypoints = 20;
      KeypointFast keypoints[numberOfKeypoints];
      ...
      KeypointFast queryPoints[numberOfKeypoints];
