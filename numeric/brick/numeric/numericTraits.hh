...
namespace brick {
  ...
  namespace numeric {
    ...
    public:
      ...
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::Int16> {
      typedef common::Int16 TextOutputType;
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::UnsignedInt16> {
      typedef common::UnsignedInt16 TextOutputType;
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::Int32> {
      typedef common::Int32 TextOutputType;
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::UnsignedInt32> {
      typedef common::UnsignedInt32 TextOutputType;
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::Int64> {
      typedef common::Int64 TextOutputType;
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::UnsignedInt64> {
      typedef common::UnsignedInt64 TextOutputType;
      inline bool isIntegral() {return true;}
    };
    ...
    struct NumericTraits<common::Float32> {
      typedef common::Float32 TextOutputType;
      inline bool isIntegral() {return false;}
    };


    template <>
    struct NumericTraits<common::Float64> {
      typedef common::Float64 TextOutputType;
      inline bool isIntegral() {return false;}
    };
